...
public class TestDatabaseContainer extends ExternalResource
{
    ...
    protected void before() throws Throwable
    {
        ...
        container.changePort("127.0.0.1", 6432, 6432, "tcp", true);
        container.changePort("0.0.0.0", 54329, 5432, "tcp", true);
        ...
        docker.teardown(Arrays.asList(container), (c,t) -> {});
        docker.networkUp(TestNetName);
        docker.containersUp(Arrays.asList(container), s -> {});
