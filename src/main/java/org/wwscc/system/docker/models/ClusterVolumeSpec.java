...
import org.wwscc.system.docker.models.ClusterVolumeSpecAccessMode;

/**
 * Cluster-specific options used to create the volume. 
 */
@ApiModel(description = "Cluster-specific options used to create the volume. ")
...
public class ClusterVolumeSpec {
  ...
  private ClusterVolumeSpecAccessMode accessMode = null;
