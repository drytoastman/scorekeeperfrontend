 ...
 */
@ApiModel(description = "DeviceInfo represents a device that can be used by a container. ")
...
public class DeviceInfo {
  ...
  public DeviceInfo source(String source) {
    this.source = source;
    return this;
  }
   ...
   * @return source
  **/
  @ApiModelProperty(example = "cdi", value = "The origin device driver. ")
   ...
   * @return ID
  **/
  @ApiModelProperty(example = "vendor.com/gpu=0", value = "The unique identifier for the device within its source driver. For CDI devices, this would be an FQDN like \"vendor.com/gpu=0\". ")
  public String getID() {
    return ID;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.source, deviceInfo.source) &&
