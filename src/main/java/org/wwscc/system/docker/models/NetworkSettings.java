...
import org.wwscc.system.docker.models.Address;
...
public class NetworkSettings {
   ...
   * @return bridge
  **/
  @ApiModelProperty(example = "docker0", value = "Name of the default bridge interface when dockerd's --bridge flag is set. ")
  ...
  **/
   ...
   * @return hairpinMode
  **/
  @ApiModelProperty(example = "false", value = "Indicates if hairpin NAT should be enabled on the virtual interface.  Deprecated: This field is never set and will be removed in a future release. ")
  ...
  **/
  @ApiModelProperty(example = "", value = "IPv6 unicast address using the link-local prefix.  Deprecated: This field is never set and will be removed in a future release. ")
  ...
  **/
  @ApiModelProperty(example = "", value = "Prefix length of the IPv6 unicast address.  Deprecated: This field is never set and will be removed in a future release. ")
  ...
  **/
  @ApiModelProperty(value = "Deprecated: This field is never set and will be removed in a future release.")
