 ...
 */
@ApiModel(description = "Information about a snapshot backend of the container's root filesystem. ")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2025-12-26T07:26:55.525Z")
public class RootFSStorageSnapshot {
  @JsonProperty("Name")
  private String name = null;

  public RootFSStorageSnapshot name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(value = "Name of the snapshotter.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RootFSStorageSnapshot rootFSStorageSnapshot = (RootFSStorageSnapshot) o;
    return Objects.equals(this.name, rootFSStorageSnapshot.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class RootFSStorageSnapshot {\n");
