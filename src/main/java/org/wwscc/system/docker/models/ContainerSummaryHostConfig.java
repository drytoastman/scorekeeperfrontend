 ...
 */
@ApiModel(description = "Summary of host-specific runtime information of the container. This is a reduced set of information in the container's \"HostConfig\" as available in the container \"inspect\" response.")
...
public class ContainerSummaryHostConfig {
   ...
   * @return networkMode
  **/
  @ApiModelProperty(example = "mynetwork", value = "Networking mode (`host`, `none`, `container:<id>`) or name of the primary network the container is using.  This field is primarily for backward compatibility. The container can be connected to multiple networks for which information can be found in the `NetworkSettings.Networks` field, which enumerates settings per network.")
  ...
  public ContainerSummaryHostConfig annotations(Map<String, String> annotations) {
    this.annotations = annotations;
    return this;
  }

  public ContainerSummaryHostConfig putAnnotationsItem(String key, String annotationsItem) {
   ...
   * @return annotations
  **/
  @ApiModelProperty(example = "{\"io.kubernetes.docker.type\":\"container\",\"io.kubernetes.sandbox.id\":\"3befe639bed0fd6afdd65fd1fa84506756f59360ec4adc270b0fdac9be22b4d3\"}", value = "Arbitrary key-value metadata attached to the container.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.networkMode, containerSummaryHostConfig.networkMode) &&
        Objects.equals(this.annotations, containerSummaryHostConfig.annotations);
  }

  @Override
  public int hashCode() {
    return Objects.hash(networkMode, annotations);
  }
