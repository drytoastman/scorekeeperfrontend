 ...
 */
@ApiModel(description = "represents the port status of a task's host ports whose service has published host ports")
...
public class PortStatus {
  ...
  public PortStatus ports(List<EndpointPortConfig> ports) {
    this.ports = ports;
    return this;
  }

  public PortStatus addPortsItem(EndpointPortConfig portsItem) {
    if (this.ports == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.ports, portStatus.ports);
  }
