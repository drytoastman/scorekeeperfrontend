 ...
 */
@ApiModel(description = "OK response to NetworkCreate operation")
...
public class NetworkCreateResponse {
   ...
   * @return id
  **/
  @ApiModelProperty(example = "b5c4fc71e8022147cd25de22b22173de4e3b170134117172eb595cb91b4e7e5d", required = true, value = "The ID of the created network.")
  public String getId() {
    return id;
  }
   ...
   * @return warning
  **/
  @ApiModelProperty(example = "", required = true, value = "Warnings encountered when creating the container")
