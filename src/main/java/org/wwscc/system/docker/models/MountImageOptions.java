 ...
 */
@ApiModel(description = "Optional configuration for the `image` type.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2025-12-26T07:26:55.525Z")
public class MountImageOptions {
  @JsonProperty("Subpath")
  private String subpath = null;

  public MountImageOptions subpath(String subpath) {
   ...
   * @return subpath
  **/
  @ApiModelProperty(example = "dir-inside-image/subdirectory", value = "Source path inside the image. Must be relative without any back traversals.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MountImageOptions mountImageOptions = (MountImageOptions) o;
    return Objects.equals(this.subpath, mountImageOptions.subpath);
  }

  @Override
  public int hashCode() {
    return Objects.hash(subpath);
  }
  ...
  public String toString() {
    ...
    sb.append("class MountImageOptions {\n");
