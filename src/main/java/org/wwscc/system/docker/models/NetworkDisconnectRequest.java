 ...
 */
@ApiModel(description = "NetworkDisconnectRequest represents the data to be used to disconnect a container from a network. ")
...
public class NetworkDisconnectRequest {
   ...
   * @return container
  **/
  @ApiModelProperty(example = "3613f73ba0e4", required = true, value = "The ID or name of the container to disconnect from the network.")
   ...
   * @return force
  **/
  @ApiModelProperty(example = "false", value = "Force the container to disconnect from the network.")
