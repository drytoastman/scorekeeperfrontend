 ...
 */
@ApiModel(description = "An identity token was generated successfully. ")
...
public class AuthResponse {
   ...
   * @return status
  **/
  @ApiModelProperty(example = "Login Succeeded", required = true, value = "The status of the authentication")
  ...
  public AuthResponse identityToken(String identityToken) {
  ...
  **/
  @ApiModelProperty(example = "9cbaf023786cd7...", value = "An opaque token used to authenticate a user after a successful login")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.status, authResponse.status) &&
        Objects.equals(this.identityToken, authResponse.identityToken);
  }
