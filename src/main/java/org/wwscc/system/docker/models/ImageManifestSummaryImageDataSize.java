...
public class ImageManifestSummaryImageDataSize {
  @JsonProperty("Unpacked")
  private Long unpacked = null;

  public ImageManifestSummaryImageDataSize unpacked(Long unpacked) {
   ...
   * @return unpacked
  **/
  @ApiModelProperty(example = "3987495", required = true, value = "Unpacked is the size (in bytes) of the locally unpacked (uncompressed) image content that's directly usable by the containers running this image. It's independent of the distributable content - e.g. the image might still have an unpacked data that's still used by some container even when the distributable/compressed content is already gone. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ImageManifestSummaryImageDataSize imageManifestSummaryImageDataSize = (ImageManifestSummaryImageDataSize) o;
    return Objects.equals(this.unpacked, imageManifestSummaryImageDataSize.unpacked);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImageManifestSummaryImageDataSize {\n");
