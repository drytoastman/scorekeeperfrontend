 ...
 */
@ApiModel(description = "Actor describes something that generates events, like a container, network, or a volume. ")
...
public class EventActor {
   ...
   * @return ID
  **/
  @ApiModelProperty(example = "ede54ee1afda366ab42f824e8a5ffd195155d853ceaec74a927f249ea270c743", value = "The ID of the object emitting the event")
  public String getID() {
    return ID;
  }
   ...
   * @return attributes
  **/
  @ApiModelProperty(example = "{\"com.example.some-label\":\"some-label-value\",\"image\":\"alpine:latest\",\"name\":\"my-container\"}", value = "Various key/value attributes of the object, depending on its type. ")
