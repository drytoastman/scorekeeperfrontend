 ...
 */
@ApiModel(description = "The namespaces that the daemon uses for running containers and plugins in containerd. These namespaces can be configured in the daemon configuration, and are considered to be used exclusively by the daemon, Tampering with the containerd instance may cause unexpected behavior.  As these namespaces are considered to be exclusively accessed by the daemon, it is not recommended to change these values, or to change them to a value that is used by other systems, such as cri-containerd. ")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2025-12-26T07:26:55.525Z")
public class ContainerdInfoNamespaces {
  @JsonProperty("Containers")
  private String containers = "moby";

  @JsonProperty("Plugins")
  private String plugins = "plugins.moby";

  public ContainerdInfoNamespaces containers(String containers) {
   ...
   * @return containers
  **/
  @ApiModelProperty(example = "moby", value = "The default containerd namespace used for containers managed by the daemon.  The default namespace for containers is \"moby\", but will be suffixed with the `<uid>.<gid>` of the remapped `root` if user-namespaces are enabled and the containerd image-store is used. ")
  ...
  public ContainerdInfoNamespaces plugins(String plugins) {
   ...
   * @return plugins
  **/
  @ApiModelProperty(example = "plugins.moby", value = "The default containerd namespace used for plugins managed by the daemon.  The default namespace for plugins is \"plugins.moby\", but will be suffixed with the `<uid>.<gid>` of the remapped `root` if user-namespaces are enabled and the containerd image-store is used. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ContainerdInfoNamespaces containerdInfoNamespaces = (ContainerdInfoNamespaces) o;
    return Objects.equals(this.containers, containerdInfoNamespaces.containers) &&
        Objects.equals(this.plugins, containerdInfoNamespaces.plugins);
  }

  @Override
  public int hashCode() {
    return Objects.hash(containers, plugins);
  }
