 ...
 */
@ApiModel(description = "Response for a successful container-update.")
...
public class ContainerUpdateResponse {
   ...
   * @return warnings
  **/
  @ApiModelProperty(example = "[\"Published ports are discarded when using host network mode\"]", value = "Warnings encountered when updating the container.")
