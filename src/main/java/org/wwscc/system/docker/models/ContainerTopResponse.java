 ...
 */
@ApiModel(description = "Container \"top\" response.")
...
public class ContainerTopResponse {
   ...
   * @return titles
  **/
  @ApiModelProperty(example = "{\"Titles\":[\"UID\",\"PID\",\"PPID\",\"C\",\"STIME\",\"TTY\",\"TIME\",\"CMD\"]}", value = "The ps column titles")
   ...
   * @return processes
  **/
  @ApiModelProperty(example = "{\"Processes\":[[\"root\",\"13642\",\"882\",\"0\",\"17:03\",\"pts/0\",\"00:00:00\",\"/bin/bash\"],[\"root\",\"13735\",\"13642\",\"0\",\"17:06\",\"pts/0\",\"00:00:00\",\"sleep 10\"]]}", value = "Each process running in the container, where each process is an array of values corresponding to the titles.")
