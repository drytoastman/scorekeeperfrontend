 ...
 */
@ApiModel(description = "The config-only network source to provide the configuration for this network. ")
...
public class ConfigReference {
   ...
   * @return network
  **/
  @ApiModelProperty(example = "config_only_network_01", value = "The name of the config-only network that provides the network's configuration. The specified network must be an existing config-only network. Only network names are allowed, not network IDs. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ConfigReference configReference = (ConfigReference) o;
    return Objects.equals(this.network, configReference.network);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConfigReference {\n");
