 ...
 */
@ApiModel(description = "Describes the result obtained from contacting the registry to retrieve image metadata. ")
...
public class DistributionInspect {
  ...
  private List<OCIPlatform> platforms = new ArrayList<>();
  ...
  **/
  ...
  public DistributionInspect platforms(List<OCIPlatform> platforms) {
  ...
  **/
  ...
  public List<OCIPlatform> getPlatforms() {
    return platforms;
  }

  public void setPlatforms(List<OCIPlatform> platforms) {
    this.platforms = platforms;
  }
