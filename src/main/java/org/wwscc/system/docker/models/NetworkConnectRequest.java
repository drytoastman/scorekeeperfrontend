 ...
 */
@ApiModel(description = "NetworkConnectRequest represents the data to be used to connect a container to a network. ")
...
public class NetworkConnectRequest {
   ...
   * @return container
  **/
  @ApiModelProperty(example = "3613f73ba0e4", required = true, value = "The ID or name of the container to connect to the network.")
