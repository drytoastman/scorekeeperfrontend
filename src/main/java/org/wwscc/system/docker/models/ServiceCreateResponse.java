 ...
 */
@ApiModel(description = "contains the information returned to a client on the creation of a new service. ")
...
public class ServiceCreateResponse {
   ...
   * @return ID
  **/
  @ApiModelProperty(example = "ak7w3gjqoa3kuz8xcpnyy0pvl", value = "The ID of the created service.")
  public String getID() {
    return ID;
  }
   ...
   * @return warnings
  **/
  @ApiModelProperty(example = "[\"unable to pin image doesnotexist:latest to digest: image library/doesnotexist:latest not found\"]", value = "Optional warning message.  FIXME(thaJeztah): this should have \"omitempty\" in the generated type. ")
