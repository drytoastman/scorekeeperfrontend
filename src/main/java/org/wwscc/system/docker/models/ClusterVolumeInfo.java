...
import org.wwscc.system.docker.models.Topology;

/**
 * Information about the global status of the volume. 
 */
@ApiModel(description = "Information about the global status of the volume. ")
...
public class ClusterVolumeInfo {
  ...
  private Long capacityBytes = null;
  ...
  **/
  @ApiModelProperty(value = "The capacity of the volume in bytes. A value of 0 indicates that the capacity is unknown. ")
  ...
  **/
  @ApiModelProperty(value = "A map of strings to strings returned from the storage plugin when the volume is created. ")
   ...
   * @return volumeID
  **/
  @ApiModelProperty(value = "The ID of the volume as returned by the CSI storage plugin. This is distinct from the volume's ID as provided by Docker. This ID is never used by the user when communicating with Docker to refer to this volume. If the ID is blank, then the Volume has not been successfully created in the plugin yet. ")
  ...
  public ClusterVolumeInfo accessibleTopology(List<Topology> accessibleTopology) {
    this.accessibleTopology = accessibleTopology;
    return this;
  }

  public ClusterVolumeInfo addAccessibleTopologyItem(Topology accessibleTopologyItem) {
  ...
  **/
  @ApiModelProperty(value = "The topology this volume is actually accessible from. ")
